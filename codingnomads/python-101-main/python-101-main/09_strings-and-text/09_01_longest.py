...
print(len(longest_german_word), 'characters') #61
print(len(longest_hungarian_word), 'characters') #44
print(len(longest_finnish_word), 'characters') #61
print(len(strong_password), 'characters') #62